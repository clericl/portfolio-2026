...
export const NUMBER_OF_HALF_ROTATIONS = PLATFORMS.length - 1;
export const STAIRS_PER_HALF_ROTATION = 18;
export const DEGREE_IN_RADIANS = 0.0174533;
export const SPACE_BETWEEN_STAIRS = 1.5;
export const STAIR_HEIGHT = 0.1;
export const HALF_ROTATION_HEIGHT = (SPACE_BETWEEN_STAIRS) * STAIRS_PER_HALF_ROTATION;
export const STAIRCASE_HEIGHT = HALF_ROTATION_HEIGHT * NUMBER_OF_HALF_ROTATIONS;
