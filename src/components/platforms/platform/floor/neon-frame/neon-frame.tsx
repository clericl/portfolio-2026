...
import { RADIAN_IN_DEGREES, STAIR_HEIGHT } from "../../../../../utils";
  ...
  useFrame(({ clock }) => {
    ...
    groupRef.current.traverse((obj) => {
      if (obj instanceof Mesh) {
        obj.material.color = new Color(
          `hsl(${nextHue * RADIAN_IN_DEGREES}, 35%, 70%)`,
        );
        obj.material.emissive = new Color(
          `hsl(${nextHue * RADIAN_IN_DEGREES}, 50%, 50%)`,
        );
      }
    });
  });
