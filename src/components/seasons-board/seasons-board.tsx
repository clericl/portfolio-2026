...
export function SeasonsBoard({ open }: SeasonsBoardProps) {
  ...
  const seasonRef = useRef<Season>(null)
  ...
  return (
    <group position={[0, 6.5, 0]}>
      ...
      <animated.group scale={props.scale}>
        <group ref={springRef} visible={false}>
          <Spring count={200} radius={20} />
        </group>
        <group ref={summerRef} visible={false}>
          <Summer count={200} radius={20} />
        </group>
        <group ref={autumnRef} visible={false}>
          <Autumn count={200} radius={20} />
        </group>
        <group ref={winterRef} visible={false}>
          <Winter count={200} radius={20} />
        </group>
      </animated.group>
    </group>
  )
